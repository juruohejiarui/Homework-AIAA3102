...
\input{../report_assets/tables/table_15_ticket1_dev_probe_ledger.tex}
...
OpenAI Chatgpt was used as the repository-operating AI assistant \cite{openai-codex}. Chatgpt assisted with repository inspection, requirement decomposition, implementation planning, Python implementation, test drafting, artifact review, reproducibility auditing, and report preparation under human supervision. The retained interaction record is a curated reconstruction supported by files and commands; it is not a verbatim export of all messages or hidden model reasoning.
